...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_uart_tx is
  ...
  signal \bittimer[3]_i_4_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \bittimer[2]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \bittimer[3]_i_3\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \bittimer[3]_i_4\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of sending_i_1 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of sig_parity_i_2 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of tx_done_tick_o_i_1 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of tx_done_tick_o_i_2 : label is "soft_lutpair6";
...
\bittimer[3]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => \state__0\(2),
      I5 => \bittimer[3]_i_4_n_0\,
      O => \bittimer[3]_i_1_n_0\
    );
\bittimer[3]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"1E"
    )
        port map (
...
\bittimer[3]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
clk_baudrate_i_2: unisim.vcomponents.LUT6
    generic map(
      INIT => X"1151111113111111"
    )
        port map (
      I0 => \bittimer[3]_i_4_n_0\,
      I1 => \state__0\(2),
...
sig_parity_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"40FF0400"
    )
        port map (
