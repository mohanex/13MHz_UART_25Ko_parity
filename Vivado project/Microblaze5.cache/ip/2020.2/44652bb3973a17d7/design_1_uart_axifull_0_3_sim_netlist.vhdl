...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_uart_tx is
  ...
  attribute SOFT_HLUTNM of \bitcntr[0]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \bitcntr[1]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \bittimer[0]_i_1\ : label is "soft_lutpair12";
  ...
  attribute SOFT_HLUTNM of \bittimer[9]_i_4\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \bittimer[9]_i_6\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of clk_baudrate_i_3 : label is "soft_lutpair10";
  ...
  attribute SOFT_HLUTNM of sig_parity_i_3 : label is "soft_lutpair5";
...
\bitcntr[2]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"0001000F"
    )
        port map (
...
clk_baudrate_i_3: unisim.vcomponents.LUT3
    generic map(
      INIT => X"F7"
    )
        port map (
...
clk_baudrate_i_4: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
sig_parity_i_4: unisim.vcomponents.LUT4
    generic map(
      INIT => X"6996"
    )
        port map (
