...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_uart_tx is
  ...
  signal \shreg[16]_i_4_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \bittimer[2]_i_1\ : label is "soft_lutpair11";
  ...
  attribute SOFT_HLUTNM of \bittimer[8]_i_2\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \bittimer[9]_i_4\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \bittimer[9]_i_6\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of clk_baudrate_i_3 : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of clk_baudrate_i_4 : label is "soft_lutpair5";
...
clk_baudrate_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"1E"
    )
        port map (
...
\shreg[16]_i_4\: unisim.vcomponents.LUT6
    generic map(
...
tx_o_i_5: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
