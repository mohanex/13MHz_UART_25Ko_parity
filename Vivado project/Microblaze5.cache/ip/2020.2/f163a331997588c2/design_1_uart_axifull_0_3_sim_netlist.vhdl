...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_uart_tx is
  ...
  attribute SOFT_HLUTNM of \bittimer[10]_i_3\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \bittimer[10]_i_5\ : label is "soft_lutpair8";
  ...
  attribute SOFT_HLUTNM of \bittimer[7]_i_2\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of clk_baudrate_i_4 : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of sending_i_1 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \shreg[16]_i_3\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of sig_parity_i_3 : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of tx_o_i_5 : label is "soft_lutpair10";
...
\bittimer[8]_i_1\: unisim.vcomponents.LUT5
    generic map(
      ...
      I4 => \bittimer[10]_i_4_n_0\,
      O => bittimer(8)
    );
\bittimer[9]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"00F7000800FF0000"
    )
        port map (
      I0 => \bittimer_reg_n_0_[7]\,
      I1 => \bittimer_reg_n_0_[6]\,
...
clk_baudrate_i_3: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
clk_baudrate_i_4: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFDFFFFF"
    )
        port map (
...
sig_parity_i_4: unisim.vcomponents.LUT6
    generic map(
...
tx_o_i_6: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000000000001"
    )
        port map (
