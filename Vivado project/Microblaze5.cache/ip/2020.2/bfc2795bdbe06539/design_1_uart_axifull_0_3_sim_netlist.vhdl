...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_uart_tx is
  ...
  signal \bittimer[4]_i_2_n_0\ : STD_LOGIC;
  signal \bittimer[4]_i_3_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \bitcntr[0]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \bitcntr[1]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \bittimer[0]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \bittimer[1]_i_1\ : label is "soft_lutpair16";
  ...
  attribute SOFT_HLUTNM of \bittimer[4]_i_2\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \bittimer[4]_i_3\ : label is "soft_lutpair15";
  ...
  attribute SOFT_HLUTNM of \cntr[5]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \cntr[6]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \cntr[7]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \cntr[9]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \cntr[9]_i_2\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \cntr[9]_i_5\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \din[0]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \din[1]_i_1\ : label is "soft_lutpair8";
  ...
  attribute SOFT_HLUTNM of \mba_mem_address[6]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of sending_i_1 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \shreg[7]_i_2\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of tx_done_tick_o_i_1 : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of tx_o_i_2 : label is "soft_lutpair14";
...
\bittimer[3]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"AAAA5540"
    )
        port map (
      I0 => \bittimer[4]_i_3_n_0\,
      I1 => \state__0\(0),
      I2 => \state__0\(1),
      I3 => \bittimer_reg_n_0_[4]\,
...
\bittimer[4]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\bittimer[4]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FF00552A"
    )
        port map (
      ...
      I2 => \state__0\(1),
      I3 => \bittimer_reg_n_0_[4]\,
      I4 => \bittimer[4]_i_3_n_0\,
      O => \bittimer[4]_i_2_n_0\
    );
\bittimer[4]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"7F"
    )
        port map (
...
tx_o_i_4: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00004000"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_uart_axifull_v1_0_S01_AXI is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \axi_araddr[5]_i_2\ : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of \axi_araddr[6]_i_2\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \axi_araddr[7]_i_2\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \axi_araddr[9]_i_7\ : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of \axi_arlen_cntr[0]_i_1\ : label is "soft_lutpair29";
  ...
  attribute SOFT_HLUTNM of \axi_arlen_cntr[7]_i_3\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \axi_arready_i_1__0\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of axi_arready_i_2 : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of axi_arready_i_3 : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of axi_arready_i_5 : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of axi_arv_arr_flag_i_1 : label is "soft_lutpair17";
  ...
  attribute SOFT_HLUTNM of \axi_awaddr[5]_i_2\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of \axi_awaddr[6]_i_2\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \axi_awaddr[7]_i_2\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \axi_awaddr[9]_i_7\ : label is "soft_lutpair25";
